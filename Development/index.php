...
<div id="loading">
  ...
  <nav class="animated bounceIn">
    ...
    <p class="layout">layout</p>
    <a href="http://www.homepage-helden.de"><img id="logo" src="img/logo.png" alt="homepage helden"></a>
    ...
    <a id="toggle" href="#">
      <img src="img/down.png" alt="toggle menu">
    </a>
    <div class="tooltip animated bounceIn">
      <img src="img/tooltip.png" alt="angle">
